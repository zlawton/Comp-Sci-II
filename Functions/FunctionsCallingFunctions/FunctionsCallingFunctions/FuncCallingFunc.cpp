/******************************************************************************
* 
*      program name:   FuncCallingFunctions.cpp
*      Author:         Zack Lawton
...
{
   float volume;
   volume = 4.0 / 3.0 * PI * (pow(radiusIn, 3.0));
   return volume;
}
...
{
   float volume;
   volume = PI * (pow(radiusIn, 2.0)) * heightIn;
   return volume;
}
...
{
   float volume;
   volume = (circumSphere(radiusIn)) * ((.3333333333));
   return volume;
}
